...
class Clientes extends CI_Controller {
        ...
        $data = array (
            ...
            'clientes' => $this->Rinos_bikes->get_all('clientes'),
            );
//            echo '<pre>';
...
//            exit();
        ...
        $this->form_validation->set_rules('cliente_data_nascimento', '', '');
        
        $cliente_tipo = $this->input->post('cliente_tipo');
        
        if ($cliente_tipo == 1) {
            $this->form_validation->set_rules('cliente_cpf', '', 'trim|exact_length[14]|is_unique[clientes.cliente_cpf_cnpj]|callback_valida_cpf');
        }else {
        ...
        $this->form_validation->set_rules('cliente_email', '', 'trim|valid_email|max_length[45]|is_unique[clientes.cliente_email]');
    ...
    if(!empty($this->input->post('cliente_celular'))){
        ...
        if ($this->form_validation->run()){
            ...
            $this->Rinos_bikes->insert('clientes', $data);
...
//            exit();
    ...
    if(!$cliente_id || !$this->Rinos_bikes->get_by_id('clientes', array('cliente_id' => $cliente_id))){
       ...
       redirect('clientes');
        ...
        if ($cliente_tipo == 1) {
            $this->form_validation->set_rules('cliente_cpf', '', 'trim|exact_length[14]|callback_valida_cpf');
        }else {
        ...
        $this->form_validation->set_rules('cliente_email', '', 'trim|valid_email|max_length[45]|callback_check_email');
...
/*
    ...
    [cliente_data_nascimento] => 1991-04-12
    [cliente_cpf] => 391.093.538-95  // EXPLICAR
    [cliente_rg_ie] => 39.144.238-7
    [cliente_email] => leonardo@rinosbikes.com
    [cliente_telefone] => (44) 3333-3333
    [cliente_celular] => (44) 99999-9999
    [cliente_endereco] => Rua do aprendizado
    [cliente_numero_endereco] => 1000
    [cliente_complemento] => corra atras dos seus sonhos
    [cliente_bairro] => que voce alcança
    [cliente_cidade] => Persista
    [cliente_cep] => 80000-000
    [cliente_estado] => SP
    [cliente_ativo] => 0
    [cliente_obs] => essa deu trabalho!!
    [cliente_tipo] => 1
    [cliente_id] => 1 
 */            
            ...
            $this->Rinos_bikes->update('clientes', $data, array('cliente_id' => $cliente_id));
            ...
            'scripts' => array(
                ...
                'cliente' => $this->Rinos_bikes->get_by_id('clientes', array('cliente_id' => $cliente_id)),
            );
//            echo '<pre>';
//            print_r($data['cliente']);
//            exit();
        ...
        public function check_rg_ie($cliente_rg_ie) {
            ...
            if($this->Rinos_bikes->get_by_id('clientes', array('cliente_rg_ie' => $cliente_rg_ie, 'cliente_id !=' => $cliente_id))){
        ...
        public function check_email($cliente_email) {
            ...
            if($this->Rinos_bikes->get_by_id('clientes', array('cliente_rg_ie' => $cliente_email, 'cliente_id !=' => $cliente_id))){
        ...
        public function check_telefone($cliente_telefone) {
            ...
            if($this->Rinos_bikes->get_by_id('clientes', array('cliente_telefone' => $cliente_telefone, 'cliente_id !=' => $cliente_id))){
        ...
        public function check_celular($cliente_celular) {
            ...
            if($this->Rinos_bikes->get_by_id('clientes', array('cliente_celular' => $cliente_celular, 'cliente_id !=' => $cliente_id))){
        ...
        if ($this->input->post('cliente_id')) {
            ...
            if ($this->Rinos_bikes->get_by_id('clientes', array('cliente_id !=' => $cliente_id, 'cliente_cpf_cnpj' => $cpf))) {
        ...
        if ($this->input->post('cliente_id')) {
            ...
            if ($this->Rinos_bikes->get_by_id('clientes', array('cliente_id !=' => $cliente_id, 'cliente_cpf_cnpj' => $cnpj))) {
        ...
        if(!$cliente_id || !$this->Rinos_bikes->get_by_id('clientes', array('cliente_id' => $cliente_id))){
            ...
            $this->Rinos_bikes->delete('clientes', array('cliente_id' => $cliente_id));
            redirect('clientes');
        }
    }
