        ...
        public function edit($fornecedor_id = NULL) {
            ...
            if($this->form_validation->run()){
               ...
               'titulo' => 'Atualizar Fornecedor',
                ...
                'fornecedor' => $this->Rinos_bikes->get_by_id('fornecedores', array('fornecedor_id' => $fornecedor_id)),
            );
...
//            exit();
            ...
            [fornecedor_razao] => Leonardo Industria LTDA
            [fornecedor_nome_fantasia] => Leonardo Corp
            [fornecedor_cnpj] => 67.882.704/0001-06
            [fornecedor_ie] => 
            [fornecedor_telefone] => 
            [fornecedor_celular] => 
            [fornecedor_email] => leonardo@corp.com
            [fornecedor_contato] => L Gerente
            [fornecedor_cep] => 
            [fornecedor_endereco] => 
            [fornecedor_numero_endereco] => 
            [fornecedor_bairro] => 
        ...
        public function check_razao_social($fornecedor_razao) {
            ...
            if($this->Rinos_bikes->get_by_id('fornecedores', array('fornecedor_razao' => $fornecedor_razao, 'fornecedor_id !=' => $fornecedor_id))){
        ...
        public function check_nome_fantasia($fornecedor_nome_fantasia) {
            ...
            if($this->Rinos_bikes->get_by_id('fornecedores', array('fornecedor_nome_fantasia' => $fornecedor_nome_fantasia, 'fornecedor_id !=' => $fornecedor_id))){
                $this->form_validation->set_message('callback_check_nome_fantasia', 'Esse Nome Fantasia Já Existe');
                return FALSE;
            }else{
                return TRUE;
        ...
        public function check_fornecedor_email($fornecedor_email) {
            ...
            if($this->Rinos_bikes->get_by_id('fornecedores', array('fornecedor_email' => $fornecedor_email, 'fornecedor_id !=' => $fornecedor_id))){
        ...
        public function check_fornecedor_telefone($fornecedor_telefone) {
            ...
            if($this->Rinos_bikes->get_by_id('fornecedores', array('fornecedor_telefone' => $fornecedor_telefone, 'fornecedor_id !=' => $fornecedor_id))){
        ...
        public function check_fornecedor_celular($fornecedor_celular) {
            ...
            if($this->Rinos_bikes->get_by_id('fornecedores', array('fornecedor_celular' => $fornecedor_celular, 'fornecedor_id !=' => $fornecedor_id))){
        ...
        if ($this->input->post('fornecedor_id')) {
            ...
            if ($this->Rinos_bikes->get_by_id('fornecedores', array('fornecedor_id !=' => $fornecedor_id, 'fornecedor_cnpj' => $cnpj))) {
