            ...
            <div class="card-body">
                ...
                <form class="user" method="POST" name="form_edit">
                    ...
                    <fieldset class="mt-4 border p-2 mb-3">
                        ...
                        <div class="col-md-6">
                             <label>E-Mail</label>
                             <input type="email" class="form-control form-control-user" name='cliente_email' placeholder="E-Mail" value="<?php echo $cliente->cliente_email; ?>">
                    ...
                    <fieldset class="mt-4 border p-2 mb-3">
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-2">
                            <label>Numero</label>
                             <input type="text" class="form-control form-control-user" name='cliente_numero_endereco'  placeholder="Numero" value="<?php echo $cliente->cliente_numero_endereco; ?>">
