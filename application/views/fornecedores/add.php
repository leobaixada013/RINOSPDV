                ...
                <form class="user" method="POST" name="form_add">
                    ...
                    <fieldset class="mt-4 border p-2 mb-3">
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-2">
                            <label>Numero</label>
                             <input type="text" class="form-control form-control-user" name='fornecedor_numero_endereco'  placeholder="Numero" value="<?php echo set_value('fornecedor_numero_endereco'); ?>">
