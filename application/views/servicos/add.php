                ...
                <form class="user" method="POST" name="form_add">
                    <fieldset class="mt-4 border p-2 mb-3">
                        ...
                        <div class="col-md-3">
                            ...
                            <textarea class="form-control form-control-user" name='servico_descricao'  placeholder="Serviço Descrição" style="min-height: 100px!important"><?php echo set_value('servico_descricao'); ?></textarea>
