                ...
                <form class="user" method="POST" name="form_edit">
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-md-12">
                             ...
                             <textarea class="form-control form-control-user" name='sistema_txt_ordem_servico' placeholder="Texto da Ordem de Serviço e Venda" value=""><?php echo $sistema->sistema_txt_ordem_servico; ?></textarea>
